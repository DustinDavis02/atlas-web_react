...
describe('NotificationItem', () => {
  ...
  it('renders the correct html from value prop', () => {
    const wrapper = shallow(<NotificationItem type="default" value="test" id={1} markAsRead={jest.fn()} />);
    expect(wrapper.text()).toContain("test");
  });

  it('renders the correct html from html prop', () => {
    const htmlData = { __html: '<u>test</u>' };
    const wrapper = shallow(<NotificationItem type="default" html={htmlData} id={1} markAsRead={jest.fn()} />);
